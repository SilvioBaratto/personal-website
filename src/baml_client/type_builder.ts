...
export default class TypeBuilder {
    ...
    constructor() {
        ...
        this.QuestionCategory = this.tb.enumViewer("QuestionCategory", [
          "EXPERIENCE","TECHNICAL_SKILLS","PROJECTS","EDUCATION","LANGUAGES","CAREER_JOURNEY","GENERAL","CONTACT","OFF_TOPIC",
        ]);
