...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async StreamChatWithSilvio(
        user_question: string,conversation_history?: string[] | null,context?: types.ConversationContext | null,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.StreamingChatResponse> {
          try {
          ...
          if (options.onTick) {
          const stream = this.stream.StreamChatWithSilvio(
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            "StreamChatWithSilvio",
            {
            "user_question": user_question,"conversation_history": conversation_history?? null,"context": context?? null
            },
            ...
            return raw.parsed(false) as types.StreamingChatResponse
            } catch (error) {
            ...
            user_question: string,conversation_history?: string[] | null,context?: types.ConversationContext | null,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.StreamingChatResponse, types.StreamingChatResponse>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for StreamChatWithSilvio", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.StreamingChatResponse, types.StreamingChatResponse>(
                  raw,
                  (a): partial_types.StreamingChatResponse => a,
                  (a): types.StreamingChatResponse => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
                  } catch (error) {
